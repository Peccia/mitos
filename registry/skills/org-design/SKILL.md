---
name: org-design
description: "Run a substantive request through the simulated design studio — CEO (creative intent), Creative Director (concept + plan from real context), Studio Manager (workspace execution). Includes extended C-suite."
version: 1.0.0
author: Mitos
license: MIT
