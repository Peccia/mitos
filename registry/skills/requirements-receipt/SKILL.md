...
- **If a store is named above**, create a document there titled `<work item key> — requirements-receipt`,
  ...
  reader which work item and which run this document belongs to; a store copy published without it
  is indistinguishable from any other file in the folder and is skipped in silence.
